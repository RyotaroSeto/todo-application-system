...
func (m *MockDatabase) AddTodo(ctx context.Context, todo *model.Todo) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) GetTodoList(ctx context.Context, id uint64) (*model.Todo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTodoList", ctx, id)
...
func (mr *MockDatabaseMockRecorder) GetTodoList(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTodoList", reflect.TypeOf((*MockDatabase)(nil).GetTodoList), ctx, id)
}

// UpdateTodoStatus mocks base method.
func (m *MockDatabase) UpdateTodoStatus(ctx context.Context, id uint64, status model.TodoStatus) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateTodoStatus", ctx, id, status)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateTodoStatus indicates an expected call of UpdateTodoStatus.
func (mr *MockDatabaseMockRecorder) UpdateTodoStatus(ctx, id, status any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTodoStatus", reflect.TypeOf((*MockDatabase)(nil).UpdateTodoStatus), ctx, id, status)
}
